...
public class SegmentHierarchyAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String tableName="PMI_SEGMENT_HIERARCHY";
		String messageCode1="";
		...
		int i=0;
		String sql="";
		String logFile="SEGMENT_HRC_EXP.txt";
...
try {		
		...
		int fieldNum=5;	
		String HeaderValid="CLIENT_SUBSEGMENT_ID\tCLIENT_SUBSEGMENT\tCLIENT_SEMI_SEGMENT\tCLIENT_SEGMENT_ID\tCLIENT_SEGMENT";	
	...
	if (readFileStat.equals("") && tabReadStat.equals("")) {	
		...
		for(i=0;i<lines.size();i++)
		{
		 ...
		 String[] temp=((String)(lines.get(i))).split("\t",fieldNum);
					...
					//insert to table
					sql="insert into " +tableName+"(CLIENT_SUBSEGMENT_ID,CLIENT_SUBSEGMENT,CLIENT_SEMI_SEGMENT,CLIENT_SEGMENT_ID,CLIENT_SEGMENT,CREATE_DATE,CREATE_USER) values(?,?,?,?,?,sysdate,'PMI_UPLOAD_INSERT')";
