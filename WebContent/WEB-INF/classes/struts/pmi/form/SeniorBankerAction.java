...
public class SeniorBankerAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String tableName="PMI_SENIOR_BANKER_LIST";
		String messageCode1="";
		...
		String sql="";
		String sqls="";
		String logFile="SN_BANKER_EXP.txt";
...
try {		
		...
		int fieldNum=2;	
		String HeaderValid="Senior Banker ID\tSenior Banker Name";	
	...
	if (readFileStat.equals("") && tabReadStat.equals("")) {	
		...
		for(i=0;i<lines.size();i++)
		{
		 ...
		 String[] temp=((String)(lines.get(i))).split("\t",fieldNum);
			...
			//insert to table
		 	sql="insert into "+tableName+"(employee_id) values(?)";
