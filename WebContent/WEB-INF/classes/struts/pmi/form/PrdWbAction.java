...
public class PrdWbAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String tableName="PMI_WB_PRODUCT_MAPPING";
		String messageCode1="";
		...
		String tabReadStat = null;
		String logFile="WB_PRODUCT_MAP_EXP.txt";
...
try {
		...
		int fieldNum=2;	
		String HeaderValid="WB_PRODUCT_MEMBER\tRAPM_STANDARD_PRODUCT_CODE";	
	...
	if (readFileStat.equals("") && tabReadStat.equals("")) {	
		...
		for(i=0;i<lines.size();i++)
		{
		 ...
		 String[] temp=((String)(lines.get(i))).split("\t",fieldNum);
					...
					//insert to table
					sql="insert into " +tableName+"(WB_PRODUCT_MEMBER,RAPM_STANDARD_PRODUCT_CODE) values(?,?)";
