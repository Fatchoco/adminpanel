...
public class PrdAttAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String tableName="PMI_PRD_ATT_MAPPING";
		String messageCode1="";
		...
		int i=0;
		String sql="";
		String logFile="PRD_ATT_EXP.txt";
...
try {		
		...
		int fieldNum=3;	
		String HeaderValid="PRODUCT_ID\tLIMIT_CATEGORY\tBS_TYPE";	
	...
	if (readFileStat.equals("") && tabReadStat.equals("")) {	
		...
		for(i=0;i<lines.size();i++)
		{
		 ...
		 String[] temp=((String)(lines.get(i))).split("\t",fieldNum);
		  ...
		  if(!(temp[2].equals("AI")||temp[2].equals("AN")||temp[2].equals("CT")||temp[2].equals("LI")||temp[2].equals("LN")||temp[2].equals("OT")||(temp[2].trim()).equals("")))
			 {	

					messageCode.add((String)(lines.get(i))+"\t:Invalid Balance Sheet Type "+temp[2]);
					rejected_record++;
		  ...
		  else
		  {
					...
					//insert to table
					sql="insert into " +tableName+"(PRODUCT_ID,LIMIT_CATEGORY ,BS_TYPE, CREATE_DATE, CREATE_USER  ) values(?,?,?,sysdate,'PMI_UPLOAD_INSERT')";
		...
		//System.out.println("messagecode1: " + messageCode1 );
	}	
