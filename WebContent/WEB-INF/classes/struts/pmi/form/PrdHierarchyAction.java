...
public class PrdHierarchyAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String tableName="PMI_PRODUCT_HIERARCHY";
		String messageCode1="";
		...
		String tb_flag="";
		String sql="";
		String logFile="PRD_HRC_EXP.txt";
...
try {		
		...
		int fieldNum=9;	
		String HeaderValid="PRODUCT_ID\tPRODUCT_DESC\tPRODUCT_FAMILY_CODE\tPRODUCT_FAMILY_DESC\tPRODUCT_SEGMENT_CODE\tPRODUCT_SEGMENT_DESC\tPRODUCT_AREA_CODE\tPRODUCT_AREA_DESC\tTB_FLAG";	
	...
	if (readFileStat.equals("") && tabReadStat.equals("")) {	
		...
		for(i=0;i<lines.size();i++)
		{
		 ...
		 if((temp[8].trim()).equals("")||temp[8]== null)
		 {
			tb_flag="N"; 
		 }
		 else
		 {
			 tb_flag=temp[8].trim();
					...
					//insert to table
					sql="insert into " +tableName+"(STANDARD_PRODUCT_CODE,STANDARD_PRODUCT_DESC,PRODUCT_FAMILY_CODE,PRODUCT_FAMILY_DESC,PRODUCT_SEGMENT_CODE,PRODUCT_SEGMENT_DESC,PRODUCT_AREA_CODE,PRODUCT_AREA_DESC,TB_FLAG,CREATE_DATE,CREATE_USER) values (?,?,?,?,?,?,?,?,?,SYSDATE,'PMI_UPLOAD_INSERT')";
