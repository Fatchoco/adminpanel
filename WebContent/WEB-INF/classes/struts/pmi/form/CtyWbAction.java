...
public class CtyWbAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String tableName="PMI_WB_COUNTRY_MAPPING";
		String messageCode1="";
		javax.sql.DataSource dataSource;
		java.sql.Connection myConnection = null;
		String readFileStat = "";
		String tabReadStat = "";
		String logFile="WB_CTY_MAP_EXP.txt";
...
try {		
		...
		int fieldNum=2;	
		String HeaderValid="WB_COUNTRY_MEMBER\tRAPM_COUNTRY_CODE";	
	...
	if (readFileStat.equals("") && tabReadStat.equals("")) {	
		...
		for(i=0;i<lines.size();i++)
		{
		 ...
		 String[] temp=((String)(lines.get(i))).split("\t",fieldNum);
					...
					//insert to table
					sql="insert into " +tableName+"(wb_country_member,rapm_country_code, CREATE_DATE, CREATE_USER) values(?,?, SYSDATE, 'PMI_UPLOAD_INSERT')";
