...
public class SegmentWbAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String tableName="PMI_WB_SEGMENT_MAPPING";
		String messageCode1="";
		...
		int i=0;
		String sql="";
		String logFile="WB_SEGMENT_MAP_EXP.txt";
...
try {		
		...
		int fieldNum=2;	
		String HeaderValid="WB_CLIENT_MEMBER\tRAPM_CLIENT_SUBSEGMENT_ID";	
	...
	if (readFileStat.equals("") && tabReadStat.equals("")) {	
		...
		for(i=0;i<lines.size();i++)
		{
		 ...
		 String[] temp=((String)(lines.get(i))).split("\t",fieldNum);
					...
					//insert to table
					sql="insert into " +tableName+"(WB_Client_member,RAPM_CLIENT_SUBSEGMENT_ID,CREATE_DATE,CREATE_USER) values(?,?,SYSDATE,'PMI_UPLOAD_INSERT')";
