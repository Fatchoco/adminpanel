...
public class DelClientTarget extends Action {
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_CLIENT_TARGET WHERE YEAR_DATA = ?";
				...
				response.sendRedirect("ListClientTarget.scb?message=Delete Success");
				return null;
