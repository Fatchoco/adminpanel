...
public class DelPrdAtt extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM pmi_prd_att_mapping WHERE product_id=? ";
		...
		response.sendRedirect("ListPrdAtt.scb?message=Delete Success");
		return null;
