...
public class DelArmCtyXlate extends Action {
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_ARM_CITY_XLATE WHERE PARTITION_KEY LIKE ?";
				...
				response.sendRedirect("ListArmCtyXlate.scb?message=Delete Success");
				return null;
