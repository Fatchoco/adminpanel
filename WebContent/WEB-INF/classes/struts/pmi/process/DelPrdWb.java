...
public class DelPrdWb extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_WB_PRODUCT_MAPPING WHERE WB_PRODUCT_MEMBER=? ";
		...
		response.sendRedirect("ListPrdWb.scb?message=Delete Success");
		return null;
