...
public class DelPmiKorea extends Action {
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_KOREA_CLIENT WHERE PARTITION_KEY LIKE ?";
				...
				response.sendRedirect("ListPmiKorea.scb?message=Delete Success");
				return null;
