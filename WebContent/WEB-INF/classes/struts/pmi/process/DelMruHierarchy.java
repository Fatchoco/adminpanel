...
public class DelMruHierarchy extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_MRU_HIERARCHY WHERE mru_code = ? ";
		...
		response.sendRedirect("ListMruHierarchy.scb?message=Delete Success");
		return null;
