...
public class DelPrdSegTag extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_PRD_SEG_TAG_MAPPING WHERE PRODUCT_SEGMENT_ID=? ";
		...
		response.sendRedirect("ListPrdSegTag.scb?message=Delete Success");
		return null;
