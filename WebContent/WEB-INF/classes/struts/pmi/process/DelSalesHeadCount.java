...
public class DelSalesHeadCount extends Action {
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_HEAD_COUNT_TB WHERE PARTITION_KEY LIKE ?";
				...
				response.sendRedirect("ListSalesHeadCount.scb?message=Delete Success");
				return null;
