...
public class DelPrdHierarchy extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM pmi_product_hierarchy WHERE standard_product_code=? ";
		...
		response.sendRedirect("ListPrdHierarchy.scb?message=Delete Success");
		return null;
