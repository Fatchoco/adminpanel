...
public class DelUsers extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_USER WHERE USERID = ? ";
					 ...
					 if((request.getParameter("DeleteList") != null && request.getParameter("DeleteList") != ""))
					{
						...
						try
						{
							if (ppStmtDelete != null) ppStmtDelete.close();
		...
		response.sendRedirect("ListUsers.scb?message=User Deleted Successfully");
		return null;
