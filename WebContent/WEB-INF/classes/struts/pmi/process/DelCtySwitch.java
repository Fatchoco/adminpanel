...
public class DelCtySwitch extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_COUNTRY_SWITCH WHERE TARGET_CODE||COUNTRY_ID=? ";
		...
		response.sendRedirect("ListCtySwitch.scb?message=Delete Success");
		return null;
