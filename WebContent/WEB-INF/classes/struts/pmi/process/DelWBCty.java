...
public class DelWBCty extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_WB_COUNTRY_MAPPING WHERE WB_COUNTRY_MEMBER=? ";
		...
		response.sendRedirect("ListWBCty.scb?message=Delete Success");
		return null;
