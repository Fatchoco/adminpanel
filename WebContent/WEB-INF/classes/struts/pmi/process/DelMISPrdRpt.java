...
public class DelMISPrdRpt extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_MIS_PRD_RPT_MAPPING WHERE PRD_RPT_ID=? ";
		...
		response.sendRedirect("ListMISPrdRpt.scb?message=Delete Success");
		return null;
