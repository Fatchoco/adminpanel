...
public class DelWBSegment extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_WB_SEGMENT_MAPPING WHERE WB_CLIENT_MEMBER=? ";
		...
		response.sendRedirect("ListWBSegment.scb?message=Delete Success");
		return null;
