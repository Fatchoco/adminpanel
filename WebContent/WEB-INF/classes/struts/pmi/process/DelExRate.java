...
public class DelExRate extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_EXCH_RATE_BOOK_COMPANY WHERE id = ? ";
		...
		response.sendRedirect("ListExRate.scb?message=Delete Success");
		return null;
