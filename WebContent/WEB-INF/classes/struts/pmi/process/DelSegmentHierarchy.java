...
public class DelSegmentHierarchy extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//initiate db connection
		 ...
		 ResultSet r;
			...
			if(!(request.getSession().getAttribute("username") != null && request.getSession().getAttribute("username") != ""))
			{
				...
				try
				{
					sqlDelete="DELETE FROM PMI_SEGMENT_HIERARCHY WHERE CLIENT_SUBSEGMENT_ID=? ";
		...
		response.sendRedirect("ListSegmentHierarchy.scb?message=Delete Success");
		return null;
