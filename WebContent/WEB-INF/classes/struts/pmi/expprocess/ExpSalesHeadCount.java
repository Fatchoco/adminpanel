...
public class ExpSalesHeadCount extends Action  {
	...
	throws Exception {
		...
		//initiate variable
		String ExpName="ExpSalesHeadCount.txt";
		String row="";
		String Header="PERIOD\tCOUNTRY\tTB_FTE";
		...
		String query = "select substr(partition_key,0,6) pkey, nvl(booking_location_id,'-'), " +
						"tb_fte " +
				" from PMI_HEAD_COUNT_TB where partition_key like '" + partk + "'" +
