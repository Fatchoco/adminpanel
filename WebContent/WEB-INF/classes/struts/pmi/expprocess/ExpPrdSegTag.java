...
public class ExpPrdSegTag extends Action  {
	...
	throws Exception {
		...
		//initiate variable
		String ExpName="ExpPrdSegTag.txt";
		String row="";
		String testNull = "";
		String Header="PRODUCT_SEGMENT_ID\tPRODUCT_SEGMENT_TAG1\tPRODUCT_SEGMENT_TAG2";
		...
		String query = "select PRODUCT_SEGMENT_ID,PRODUCT_SEGMENT_TAG1,PRODUCT_SEGMENT_TAG2 from PMI_PRD_SEG_TAG_MAPPING order by PRODUCT_SEGMENT_ID";
		try
		{
