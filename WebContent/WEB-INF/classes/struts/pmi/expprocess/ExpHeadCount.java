...
public class ExpHeadCount extends Action  {
	...
	throws Exception {
		...
		//initiate variable
		String ExpName="ExpHeadCount.txt";
		String row="";
		String Header="Period\tCountry\tOCC FTE\tOCC RM FTE";
		...
		String query = "select substr(partition_key,0,6) pkey, nvl(booking_location_id,'-'), " +
						"occ_fte, occ_rm" +
				" from PMI_HEAD_COUNT where partition_key like '" + partk + "'" +
