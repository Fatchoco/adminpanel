...
public class ExpMruHierarchy extends Action  {
	...
	throws Exception {
		...
		//initiate variable
		String ExpName="ExpMruHierarchy.txt";
		String row="";
		String Header="MRU_CODE\tMRU\tTOTAL_MRU";
		...
		String query = "select  mru_code cd, nvl(mru,'-'), nvl(total_mru,'-') tot " +
				" from PMI_MRU_HIERARCHY order by mru_code";
		try
		{
