...
public class ExpCtySwitch extends Action  {
	...
	throws Exception {
		...
		//initiate variable
		String ExpName="ExpCtySwitch.txt";
		String row="";
		String Header="SOURCE_CODE\tTARGET_CODE\tCOUNTRY_ID\tATTRIBUTE1\tATTRIBUTE2\tATTRIBUTE3";
		...
		String query = "select nvl(SOURCE_CODE,'-') src, TARGET_CODE tgt, COUNTRY_ID cty, nvl(ATTRIBUTE1,'-') attr1, nvl(ATTRIBUTE2,'-') attr2, nvl(ATTRIBUTE3,'-') attr3 from PMI_COUNTRY_SWITCH order by TARGET_CODE, COUNTRY_ID";
		try
		{
