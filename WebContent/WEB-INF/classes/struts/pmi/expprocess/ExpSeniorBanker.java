...
public class ExpSeniorBanker extends Action  {
	...
	throws Exception {
		...
		//initiate variable
		String ExpName="ExpSeniorBanker.txt";
		String row="";
		String Header="Senior Banker ID\tSenior Banker Name";
		...
		String query = "select EMPLOYEE_ID, '-' from PMI_SENIOR_BANKER_LIST order by EMPLOYEE_ID";
		try
		{
