...
<div class="content">
	...
	<table border="0" class="txtSubSubTitleContent">
		...
		<tr>
			...
			<td>
				<html-el:select property="distCode" value="" onchange="distFileNameAdd()">
		...
		<tr>
			...
			<td>
				<html-el:text property="fileName" value=""/>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<html-el:select property="distCodeInfile" value="">
					<html-el:option value="">-</html-el:option>
		...
		<tr>
			...
			<td>
				<html-el:select property="transDate" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="productCode" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="productName" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="specification" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="batchNo" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="unitName" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="invoiceNo" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="expiryDate" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="customerCode" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="customerName" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="customerCity" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="customerProvince" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="qty" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="totalsales" value="">
					<html-el:option value="">-</html-el:option>
					<c:forEach var="i" begin="1" end="50" step="1">
						<html-el:option value="C${i}"><c:out value="C${i}"/></html-el:option>
					</c:forEach>
		...
		<tr>
			...
			<td>
				<html-el:select property="transDateFormat" value="">
					<html-el:option value="">-</html-el:option>
		...
		<tr>
			...
			<td>
				<html-el:select property="expiryDateFormat" value="">
					<html-el:option value="">-</html-el:option>
					<html-el:option value="MM/DD/YYYY">MM/DD/YYYY</html-el:option>
					<html-el:option value="YYYY-MM-DD">YYYY-MM-DD</html-el:option>
					<html-el:option value="YYYY/MM/DD">YYYY/MM/DD</html-el:option>
