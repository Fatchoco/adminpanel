...
function NavigatePage()
{
	 ...
	 //window.location.href="ViewExceptionCustomer.tkd?Page="+currentPage+"&Period="+periodQ;
	 window.location.href="ViewExceptionCustomer.tkd?Page="+currentPage;
}
function Search()
{
	 //var periodQ=document.getElementsByName("cur_period")[0].value;
	 //window.location.href="ViewExceptionCustomer.tkd?Period="+periodQ;
	window.location.href="ViewExceptionCustomer.tkd";
}
function Export()
{
	 //var periodQ=document.getElementsByName("cur_period")[0].value;
	 //window.location.href="ExportExceptionCustomer.tkd?Period="+periodQ;
	window.location.href="ExportExceptionCustomer.tkd";
}
...
<title>View Unmapped Customer - Takeda</title>
		...
		<tr><td>
			<table border="0" cellspacing="0" cellpadding="0" class="data">
				...
				<tr>
					...
					<th scope="col">DIST CUSTOMER CODE</th>
					<th scope="col">DIST CUSTOMER NAME (CN)</th>
					<th scope="col">DIST CUSTOMER CITY</th>
					<th scope="col">DIST CUSTOMER PROVINCE</th>
