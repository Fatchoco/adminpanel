...
function NavigatePage()
{
	 ...
	 window.location.href="ViewMasterDistributorPrice.tkd?Page="+currentPage+"&Search1="+searchQ1+"&Search2="+searchQ2+"&Period="+periodQ;
}
function Search()
{
	 var searchQ1=document.getElementById("txtSearchDist").value;
	 var searchQ2=document.getElementById("txtSearchProd").value;
	 var periodQ=document.getElementsByName("cur_period")[0].value;
	 window.location.href="ViewMasterDistributorPrice.tkd?Search1="+searchQ1+"&Search2="+searchQ2+"&Period="+periodQ;
}
function Export()
{
	 var searchQ1=document.getElementById("txtSearchDist").value;
	 var searchQ2=document.getElementById("txtSearchProd").value;
	 var periodQ=document.getElementsByName("cur_period")[0].value;
	 window.location.href="ExportMasterDistributorPrice.tkd?Search1="+searchQ1+"&Search2="+searchQ2+"&Period="+periodQ;
}
function Delete()
{
	 var periodQ=document.getElementsByName("cur_period")[0].value;
	 ...
	 if (r==true)
	 {
	 	window.location.href="DeleteMasterDistributorPrice.tkd?Period="+periodQ;
	 }
}
...
function CopyPreviousPeriodData(a)
{
	...
	if (r==true)
	{
	 window.location.href="CopyPreviousPeriodData.tkd?m=masterdistributorprice";
	}
}
</script>

<title>View Master Distributor Price - Takeda</title>
...
<div class="content">
	...
	<b><u>Distributor Price Master - Result Page</u></b>
	</p>
	<table border="0" style="font-size: 15px;">
		...
		<tr>
			...
			<td class="txtSubSubTitleContent"><input name="txtSearchProd" type="text"
			id="txtSearchProd" onKeyPress="return readenter2(event,'Search()');"
		...
		<table border="0" cellspacing="0" cellpadding="0" class="data">
			...
			<c:forEach var="item" items="${result.rows}">
				...
				<tr id='tr_<c:out value="${item.distributor_cd}" />' <c:if test="${i % 2 == 1}"> class="oddRow" </c:if>
					...
					<td>
					<c:out value="${item.t2_unit_price}" />
		...
		<tr><td>
			<table border="0" align="right" cellpadding="0" cellspacing="0" class="tkd_button">
				<tr>
		            ...
		            <td class="tkd_button_right">&nbsp;</td>
		            <td class="tkd_button_left">&nbsp;</td>
		            <td align="center" class="tkd_button_middle"><a href="#" onclick="javascript:window.location.href='UploadMasterDistributorPrice.tkd'">UPLOAD PAGE</a></td>
		            <td class="tkd_button_right">&nbsp;</td>
		            <td class="tkd_button_left">&nbsp;</td>
