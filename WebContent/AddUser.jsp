...
<script language="javascript">
	...
	function SaveData() {
		...
		if (document.forms[0].useridName.value =="" )
			{
		...
		if (document.forms[0].userPassword.value != document.forms[0].confirmPwd.value )
		{
		   alert('Password must be the same with password confirmation!');
		   return;
		}
		
/*		if (document.forms[0].userAdmin.checked)
		{
...
<body>
	...
	<html:form action="/AddUserProcess" method="post">
		<table border=0>
			<tr>
				<td class="txtTitleContent"><b><u>User Management - Add User</u> </b></td>
			</tr>
		</table>
		<table class="txtSubSubTitleContent" border="0">
			<tr>
				<td>User Name</td>
				<td><html-el:text property="useridName" value="${FormAddEditUser.useridName}" size="20" /></td>
			...
			<tr>
				<td>Password</td>
				<td><html-el:password property="userPassword" value="" size="21" /></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>Confirm Password</td>
				<td><input type="password" name="confirmPwd" size="21"></td>
				<td>&nbsp;</td>
			</tr>
			<!--<tr>
				<td>User Type</td>
		...
		<!--<table width="300" border="0">
			<tr>
				<th colspan="2" class="txtSubTitleContent" >Access Type</th>
			</tr>
			<tr class="txtSubSubTitleContent">
				<td><input type="hidden" name="AppAccess" value="Admin" /> <html:multibox
						property="userAppAccess" value="DIST" /> Distributor Data mart</td>
				<td><html:multibox property="userAppAccess" value="IMS" /> IMS
					data mart</td>
			</tr>
		</table>-->
		<br/>
				...
				<td>
					<fieldset>
						...
						<div class="txtSubSubTitleContent">
							...
							<span><html:multibox property="userAppAccess" value="IMS" /> MARKET ANALYZER DATA MART</span>
						</div>
					</fieldset>
				</td>
			</tr>
		...
		<table border="0" align="left" cellpadding="0" cellspacing="0" class="tkd_button">
			<tr>
