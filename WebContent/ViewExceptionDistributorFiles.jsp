...
<title>View Distributor Files Exception - Takeda</title>
...
<div class="content">
	...
	<b><u>Distributor Files Exception</u></b>
	</p>
			...
			<td>
				<table border="0" cellpadding="0" cellspacing="0" class="tkd_button">
					<tr>
			            ...
			            <td align="center" class="tkd_button_middle"><a href="#" onclick="window.open('ExportLogDistributorFiles.tkd')">LAST LOG</a></td>
