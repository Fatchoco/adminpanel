...
//document.onkeyup = CheckSubmission;
	...
	{		
		...
		detailView+="<td>CRG</td>";
		detailView+="<td>Crg Number</td>";
		detailView+="<td>Crg Range</td>";
		detailView+="<td>Book Type</td>";
		detailView+="</tr>";
	...
	{
		//get <id>				
		tempCrg=listProduct[i].childNodes[0].firstChild.nodeValue.replace("_jandj_","&");														
		tempBookType = listProduct[i].childNodes[1].firstChild.nodeValue.replace("_jandj_","&");														
		tempCrgRange = listProduct[i].childNodes[2].firstChild.nodeValue.replace("_jandj_","&");														
		tempCrgNum = listProduct[i].childNodes[3].firstChild.nodeValue.replace("_jandj_","&");														
		
		detailView+="<tr id='tr_"+tempCrg+"' name='tr_"+tempCrg+"'>";	

		//get Crg
		detailView+="<td>";				
		detailView+="	<span class='TableText' >"+tempCrg+"</span>";
		detailView+="</td>";
		//get Crg Num
		detailView+="<td>";
		detailView+="	<span class='TableText'>"+tempCrgNum+"</span>";
		detailView+="</td>";
		//get CRg Range
		detailView+="<td>";
		detailView+="	<span class='TableText'>"+tempCrgRange+"</span>";
		detailView+="</td>";
		//get Book Type
		detailView+="<td>";
		detailView+="	<span class='TableText' >"+tempBookType+"</span>";
		detailView+="</td>";
